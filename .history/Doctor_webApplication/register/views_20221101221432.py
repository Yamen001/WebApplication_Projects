...
def register(request):
    if request.method == "POST":
        ...
        user = User.objects.cre/snap/code/111/usr/share/code/resources/app/out/vs/code/electron-sandbox/workbench/workbench.htmlate_user(username = username, password = password,phone_number = phone_number, email = email, gender = gender)
        user.save();
